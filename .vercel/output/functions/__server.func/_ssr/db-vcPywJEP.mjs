...
async function createPgliteSql() {
	...
	const migrate = async () => {
		const migrations = /* #__PURE__ */ Object.assign({
			...
			"/migrations/0003_plate_meta.sql": _0003_plate_meta_default,
			"/migrations/0004_dupes.sql": _0004_dupes_default
		});
